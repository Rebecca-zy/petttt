...
export default {
    ...
    methods:{
        async getJlData() {
            const _this = this
            await axios.get('/getShareByjlid',{
                params:{
                    jlid:_this.id
                }
                }).then(async res => {
                    ...
                    params:{
                        ...
                        await axios.post('/likecount?jlid='+_this.id)
                        .then(res=>{
                            _this.messageinform.lovenumber=res.data;
                        }).catch(err => {
                            console.log('错误！！！！：'+err)
                        })
                        axios.post('/starcount?jlid='+_this.id)
                        .then(res=>{
                            _this.messageinform.starnumber=res.data;
                        }).catch(err => {
                            console.log('错误！！！！：'+err)
                        })
                        axios.get('/user/getUserByNamelog/'+_this.messageinform.username)
                        .then(res=>{
